    ...
    items: [
      {
        ...
        children: [
          { label: "Suppliers", href: "/supplier", icon: <PeopleIcon fontSize="small" /> },
          { label: "Transports", href: "/transport", icon: <LocalShippingIcon fontSize="small" /> },
          { label: "Employees", href: "/employee", icon: <BadgeIcon fontSize="small" /> },
          { label: "Items", href: "/item", icon: <ViewModuleIcon fontSize="small" /> },
          { label: "Categories", href: "/category", icon: <CategoryIcon fontSize="small" /> },
          {
            label: "Sub Categories",
            href: "/subcategory",
            icon: <AccountTreeIcon fontSize="small" />,
          },
          { label: "Skills", href: "/skill", icon: <PsychologyIcon fontSize="small" /> },
        ],
      },
    ],
  },
 ...
 */
export const allNavItems: NavItem[] = navigationConfig.flatMap(group => group.items);
